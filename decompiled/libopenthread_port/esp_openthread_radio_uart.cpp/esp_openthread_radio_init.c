...

{
  ...
  iVar1 = esp::openthread::UartSpinelInterface::Init((esp_openthread_uart_config_t *)&DAT_00015dc0);
  if (iVar1 != 0) {
    uVar2 = esp_log_timestamp();
    esp_log_write(1,"OPENTHREAD",&_LC151,uVar2,"OPENTHREAD","esp_openthread_radio_init",0x28);
    return iVar1;
  }
  DAT_000160b4 = DAT_000160b4 | 0x10;
  iVar1 = ot::Spinel::
  ...
  if ((iVar1 == 0) &&
    ...
    if ((DAT_000160b4 >> 1 & 1) != 0) {
      ...
      if (((iVar1 == 0) &&
          (iVar1 = ot::Spinel::
                   RadioSpinel<esp::openthread::UartSpinelInterface,esp_openthread_mainloop_context_t>
                   ::Get(0x159b0,(char *)0x2,&_LC52,&DAT_00016028,0x80), iVar1 == 0)) &&
         (iVar1 = ot::Spinel::
                  RadioSpinel<esp::openthread::UartSpinelInterface,esp_openthread_mainloop_context_t>
                  ::Get(0x159b0,(char *)0x8,&_LC66,&DAT_000160a8), iVar1 == 0)) {
        iVar1 = ot::Spinel::
                RadioSpinel<esp::openthread::UartSpinelInterface,esp_openthread_mainloop_context_t>
        ...
        if (iVar1 == 0) {
          ...
          otLogCritPlat("%s() at %s:%d: %s",&_LC152,
            ...
            iVar1 = ot::Spinel::
                    ...
                    ::CheckRadioCapabilities
                              ((RadioSpinel<esp::openthread::UartSpinelInterface,esp_openthread_mainloop_context_t>
                                *)&s_radio);
            if (iVar1 == 0) {
              DAT_00015fb0 = &DAT_00015e30;
              DAT_00015fd0 = &DAT_00015eaf;
              DAT_00015ff0 = &DAT_00015f2e;
