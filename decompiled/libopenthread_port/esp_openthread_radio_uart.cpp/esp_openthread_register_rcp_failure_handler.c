 ...
 * Source: libopenthread_port -> esp_openthread_radio_uart.cpp.o -> esp_openthread_register_rcp_failure_handler
 *
...
void esp_openthread_register_rcp_failure_handler(undefined4 param_1)
