...

{
  ...
  if (iStack_19c != 1) {
    ...
    if (iStack_19c != 2) {
      if (uStack_198 == 0x38) {
_L0:
        iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC36,&uStack_c8);
        goto joined_r0x00011320;
      }
      if (uStack_198 < 0x39) {
        if (uStack_198 == 0x29) {
_L0:
          ...
          if (0 < iVar3) {
            ...
            for (; auStack_170[0] != 0; auStack_170[0] = auStack_170[0] - iVar3) {
              iVar3 = spinel_datatype_unpack(puVar7,&_LC36,local_180);
        ...
        if (uStack_198 < 0x2a) {
          if (uStack_198 == 5) {
            ...
            while (uStack_190 != 0) {
              iVar3 = spinel_datatype_unpack(iStack_194,&_LC30,&uStack_c8);
              if (iVar3 < 1) goto _L0;
...
_L0:
            ...
            if (uStack_198 - 0x24 < 4) goto _L0;
          }
          goto _L0;
        }
        if (uStack_198 == 0x2e) {
          iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC98,auStack_170,&uStack_c8);
        }
        else {
          if (uStack_198 < 0x2f) {
            if (uStack_198 != 0x2c) {
              if (0x2c < uStack_198) {
                if ((uStack_198 == 0x2d) && (iStack_19c == 4)) {
                  iVar3 = spinel_datatype_unpack
                                    (iStack_194,uStack_190,&_LC95,&uStack_184,local_180,auStack_170,
                                     &uStack_c8);
                  if (iVar3 < 1) goto _L0;
                  iVar3 = Snprintf((char *)this,(ulong)puVar1,acStack_ca + -(int)puVar1);
                  puVar2 = (undefined1 *)((int)puVar1 + iVar3);
                  for (uVar5 = 0; uVar5 < uStack_c8; uVar5 = uVar5 + 1 & 0xffff) {
                    iVar3 = Snprintf((char *)this,(ulong)puVar2,acStack_ca + -(int)puVar2);
                    puVar2 = puVar2 + iVar3;
                  }
                }
...
_L0:
              iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC34,&uStack_c8);
              goto joined_r0x00011320;
            }
          }
          else if (uStack_198 != 0x32) {
            if (uStack_198 < 0x33) {
              if (uStack_198 == 0x30) goto _L0;
              if (uStack_198 == 0x31) {
              ...
              if (uStack_198 == 0x37) {
_L0:
                iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC32,&uStack_c8);
                goto joined_r0x00011498;
              }
              uVar5 = 0x34;
              if (0x34 < uStack_198) goto _L0;
_L248:
              if (uStack_198 == uVar5) {
                uStack_c8 = 0;
                local_c4 = 0;
...
_L0:
          iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC38,&uStack_c8);
        }
        goto joined_r0x00011320;
      }
      if (uStack_198 == 0x803) {
        ...
        if (uStack_198 < 0x804) {
          if (uStack_198 == 0x74) {
            ...
            iStack_194 = iStack_194 + iVar3;
            uStack_190 = uStack_190 - iVar3;
            iVar3 = spinel_datatype_unpack(&_LC36,auStack_170);
joined_r0x00011320:
            if (0 < iVar3) {
              Snprintf((char *)this,(ulong)puVar1,acStack_ca + -(int)puVar1);
              goto _L0;
...
_L244:
                  ...
                  iVar3 = spinel_datatype_unpack(iStack_194,uStack_190,&_LC43,&uStack_c8);
                  goto joined_r0x00011320;
                }
                goto _L0;
              }
...
_L0:
            ...
            while (1 < uStack_190) {
              iVar3 = spinel_datatype_unpack(iStack_194,&_LC38,&uStack_c8);
              if (iVar3 < 1) goto _L0;
              iStack_194 = iStack_194 + iVar3;
              uStack_190 = uStack_190 - iVar3;
              iVar3 = Snprintf((char *)this,(ulong)puVar2,acStack_ca + -(int)puVar2);
...
_L0:
            ...
            if ((uStack_198 == 0x120d) || (uStack_198 == 0x1303)) goto _L0;
          }
        }
        else if (uStack_198 == 0x1305) {
          iVar3 = Snprintf((char *)this,(ulong)puVar1,acStack_ca + -(int)puVar1);
