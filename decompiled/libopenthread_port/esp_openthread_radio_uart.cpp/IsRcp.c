...

{
  ...
  *param_1 = false;
  iStack_9c = 100;
  iVar3 = Get((ulong)this,(char *)0x5,0x10ba4,auStack_94,&iStack_9c);
  if (iVar3 == 0) {
    iVar3 = 0;
    bVar1 = false;
    puVar2 = auStack_94;
    for (; iStack_9c != 0; iStack_9c = iStack_9c - iVar4) {
      iVar4 = spinel_datatype_unpack(puVar2,&_LC49,&iStack_98);
      if (iVar4 < 1) {
...
_L560:
    ...
    otLogCritPlat("%s() at %s:%d: %s","IsRcp",
                  ...
                  ,uVar6);
    iVar4 = Get((ulong)this,(char *)0x5,0x10ba4,auStack_94,&iStack_9c);
    iVar3 = 2;
    if (iVar4 != 7) {
      iVar3 = 1;
    }
