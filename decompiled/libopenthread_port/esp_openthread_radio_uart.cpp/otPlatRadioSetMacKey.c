...
void otPlatRadioSetMacKey
               (otInstance *aInstance,uint8_t aKeyIdMode,uint8_t aKeyId,otMacKey *aPrevKey,
               otMacKey *aCurrKey,otMacKey *aNextKey)

{
  ...
  oVar1 = ot::Spinel::
          ...
          SetMacKey(&s_radio,aKeyIdMode,aKeyId,aPrevKey,aCurrKey,aNextKey);
