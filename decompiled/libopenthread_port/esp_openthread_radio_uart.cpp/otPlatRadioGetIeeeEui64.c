 ...
 * Source: libopenthread_port -> esp_openthread_radio_uart.cpp.o -> otPlatRadioGetIeeeEui64
 *
...
void otPlatRadioGetIeeeEui64(uchar *param_1)

{
  ...
  otLogCrit(0xc,_LC2,"%s() at %s:%d: %s","otPlatRadioGetIeeeEui64",
