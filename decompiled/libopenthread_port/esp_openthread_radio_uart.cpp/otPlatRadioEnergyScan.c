...

{
  ...
  if ((DAT_00014be0 & 2) == 0) {
    ...
    DAT_00014d18._1_1_ = DAT_00014d18._1_1_ | 0x80;
    uRam00014d12 = param_1;
    uRam00014d14 = param_2;
    iVar1 = ot::Spinel::
    ...
    if (((iVar1 == 0) &&
        (iVar1 = ot::Spinel::
                 ...
                 ::Set(0x14570,(char *)0x32), iVar1 == 0)) &&
       (iVar1 = ot::Spinel::
                RadioSpinel<esp::openthread::UartSpinelInterface,esp_openthread_mainloop_context_t>
                ::Set(0x14570,(char *)0x30), iVar1 == 0)) {
      DAT_00014be1 = param_1;
    }
  }
  return iVar1;
}
