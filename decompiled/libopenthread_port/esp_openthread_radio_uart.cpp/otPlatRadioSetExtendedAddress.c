...
void otPlatRadioSetExtendedAddress(otInstance *instance,otExtAddress *address)

{
  ...
  for (uVar3 = 0; uVar3 < 8; uVar3 = uVar3 + 1) {
    auStack_18[uVar3] = *(undefined1 *)((7 - uVar3) + (int)address);
  }
  oVar1 = ot::Spinel::
          RadioSpinel<esp::openthread::UartSpinelInterface,_esp_openthread_mainloop_context_t>::
          SetExtendedAddress(&s_radio,(otExtAddress *)auStack_18);
