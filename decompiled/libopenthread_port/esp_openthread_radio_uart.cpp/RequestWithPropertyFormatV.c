...
/* ot::Spinel::RadioSpinel<esp::openthread::UartSpinelInterface,
   esp_openthread_mainloop_context_t>::RequestWithPropertyFormatV(char const*, unsigned long,
...
RequestWithPropertyFormatV
          ...
          ,char *param_1,ulong param_2,ulong param_3,char *param_4,void *param_5)

{
  *(char **)(this + 0x46c) = param_1;
