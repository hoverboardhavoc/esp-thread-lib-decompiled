 ...
 * Source: libopenthread_port -> esp_openthread_ncp.cpp.o -> NcpSend
 *
...
/* NcpSend(unsigned char const*, unsigned short) */

undefined4 NcpSend(uchar *param_1,ushort param_2)

{
  undefined2 in_register_0000202e;
  
  otPlatUartSend();
  return CONCAT22(in_register_0000202e,param_2);
}
