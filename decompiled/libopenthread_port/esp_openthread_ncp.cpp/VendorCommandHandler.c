 ...
 * Source: libopenthread_port -> esp_openthread_ncp.cpp.o -> VendorCommandHandler
 *
...
/* ot::Ncp::NcpBase::VendorCommandHandler(unsigned char, unsigned int) */

undefined4 ot::Ncp::NcpBase::VendorCommandHandler(uchar param_1,uint param_2)
