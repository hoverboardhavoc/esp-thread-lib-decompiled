 ...
 * Source: libopenthread_port -> esp_openthread_lock.o -> esp_openthread_lock_release
 *
...
{
  xQueueGiveMutexRecursive(s_openthread_task_mutex);
  xQueueGiveMutexRecursive(s_openthread_mutex);
  return;
}
