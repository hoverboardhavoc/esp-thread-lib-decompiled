 ...
 * Source: libopenthread_br -> esp_openthread_infra_if.cpp.o -> infra_if_is_self_address
 *
...
/* infra_if_is_self_address(void*) */

int infra_if_is_self_address(void *param_1)

{
  int iVar1;
  
  iVar1 = is_address_from_netif(s_netif);
  return iVar1 + -1;
}
