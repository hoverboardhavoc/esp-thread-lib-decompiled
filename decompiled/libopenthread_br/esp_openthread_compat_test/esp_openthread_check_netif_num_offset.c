 ...
 * Source: libopenthread_br -> esp_openthread_compat_test.o -> esp_openthread_check_netif_num_offset
 *
...
undefined4 esp_openthread_check_netif_num_offset(int param_1)
