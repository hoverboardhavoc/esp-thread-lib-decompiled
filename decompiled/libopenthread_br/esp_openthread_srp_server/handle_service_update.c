...
_L28:
    ...
    if (iVar1 == 0) {
      do {
        ...
        esp_log(3,"OPENTHREAD","I (%lu) %s: Add a new host, addr %s\n",uVar13,"OPENTHREAD",uVar4);
        puVar11 = (undefined4 *)((int)pvVar5 + 0x18);
        pvVar5 = (void *)*puVar11;
      } while ((void *)*puVar11 != (void *)0x0);
      goto _L28;
    }
    do {
      uVar13 = esp_log_timestamp();
  ...
  if (iVar12 == 0) {
    ...
    do {
      while( true ) {
        ...
        strncpy(acStack_114,pcVar6,sVar15);
...
_L77:
      ...
      uStack_1b2 = 0;
      uVar13 = otSrpServerServiceGetTxtData(iVar1,&uStack_1b2);
      ...
      if (uVar14 == 0) {
        ...
        puVar11 = (undefined4 *)malloc(uVar14 << 3);
        if (puVar11 == (undefined4 *)0x0) {
          iVar12 = 3;
          goto _L33;
        }
        memset(puVar11,0,uVar14 << 3);
        otDnsInitTxtEntryIterator(auStack_8c,uVar13,uStack_1b2);
        uVar16 = 0;
        while (iVar10 = otDnsGetNextTxtEntry(auStack_8c,&pcStack_1a8), iVar10 == 0) {
            ...
            do {
              if (pcStack_1a4[sVar15] == '=') {
                if ((sVar15 - 1 & 0xffff) < 0x40) {
                  strncpy(pcVar8,pcStack_1a4,sVar15);
                  pcVar8[sVar15] = '\0';
                  iVar10 = uVar14 - sVar15;
                  puVar11[uVar16 * 2] = pcVar8;
                  if ((iVar10 - 2U & 0xffff) < 0x40) {
                    uVar14 = iVar10 - 1U & 0xffff;
                    strncpy(pcVar9,pcVar7 + sVar15 + 1,uVar14);
                    pcVar9[uVar14] = '\0';
                    (puVar11 + uVar16 * 2)[1] = pcVar9;
                    goto _L51;
                  }
                }
                break;
...
_L54:
            ...
            if ((pcVar8 == (char *)0x0) || (sVar15 = strnlen(pcStack_1a8,0x41), 0x40 < sVar15))
            goto _L54;
            puVar17 = puVar11 + uVar16 * 2;
            strncpy(pcVar8,pcVar6,0x40);
            pcVar8[0x40] = '\0';
            *puVar17 = pcVar8;
            if ((pcVar9 == (char *)0x0) || (uVar14 = (uint)uStack_1a0, 0x40 < uVar14)) goto _L54;
            if (pcStack_1a4 == (char *)0x0) {
              puVar17[1] = 0;
            }
            else {
              strncpy(pcVar9,pcStack_1a4,uVar14);
              puVar17[1] = pcVar9;
              pcVar9[uVar14] = '\0';
            }
_L51:
      ...
      uVar13 = otSrpServerServiceGetPort(iVar1);
      esp_openthread_task_switching_lock_release();
      if (iVar2 == 0) {
        uVar4 = esp_log_timestamp();
        esp_log(3,"OPENTHREAD","I (%lu) %s: Add new service\n",uVar4);
        iVar2 = mdns_service_add_for_host
                          (acStack_114,acStack_d0,acStack_1b0,acStack_19c,uVar13,puVar11,uVar14);
      }
      else {
        uVar4 = esp_log_timestamp();
        ...
        if (iVar2 == 0) {
          iVar2 = mdns_service_txt_set_for_host
                            (acStack_114,acStack_d0,acStack_1b0,acStack_19c,puVar11,uVar14);
          if (iVar2 == 0) goto _L61;
          uVar13 = esp_log_timestamp();
        ...
        esp_log(1,"OPENTHREAD",pcVar6,uVar13);
      }
_L61:
      esp_openthread_task_switching_lock_acquire(0xffffffff);
      if (puVar11 != (undefined4 *)0x0) {
      ...
      for (uVar16 = 0; uVar16 < uVar14; uVar16 = uVar16 + 1 & 0xffff) {
        iVar2 = otSrpServerServiceGetSubTypeServiceNameAt(iVar1,uVar16);
        if (iVar2 == 0) {
          uVar4 = esp_log_timestamp();
          uVar13 = 0xeb;
          pcVar6 = "E (%lu) %s: %s(%d): Failed to get service subtype\n";
_L127:
          esp_log(1,"OPENTHREAD",pcVar6,uVar4,__FUNCTION___0,uVar13);
        ...
        *(void **)(uVar16 * 4 + (int)pvVar3) = pvVar5;
      }
      esp_openthread_task_switching_lock_release();
...
_L128:
    iVar12 = convert_to_ot_srp_error_code(iVar2);
  }
_L33:
  esp_openthread_get_instance();
  otSrpServerHandleServiceUpdateResult(param_1,iVar12);
  return;
}
