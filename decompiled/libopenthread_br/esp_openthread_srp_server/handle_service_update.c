...

{
  ...
  if (iVar9 != 0) {
    ...
    esp_log_write(3,"OPENTHREAD",&_LC12,uVar10,"OPENTHREAD");
    otSrpServerHostGetFullName(param_2);
    split_hostname_constprop_0(auStack_54);
    uVar10 = esp_log_timestamp();
    esp_log_write(3,"OPENTHREAD",&_LC13,uVar10,"OPENTHREAD",auStack_54);
  ...
  uVar10 = esp_log_timestamp();
  esp_log_write(3,"OPENTHREAD",&_LC14,uVar10,"OPENTHREAD");
  otSrpServerHostGetFullName(param_2);
  ...
  if (iVar9 == 0) {
    ...
    do {
      while( true ) {
        ...
        strncpy(acStack_10c,pcVar5,sVar15);
        acStack_10c[sVar15] = '\0';
        strncpy(acStack_c8,pcVar6,__n_00);
        acStack_c8[__n_00] = '\0';
        strncpy(acStack_1c4,pcVar7,__n);
        acStack_1c4[__n] = '\0';
        uVar10 = esp_log_timestamp();
        ...
        if ((iVar2 != 0) ||
           (iVar2 = mdns_service_exists_with_instance
                              (acStack_10c,acStack_c8,acStack_1c4,acStack_194), iVar2 != 0)) break;
        uVar10 = esp_log_timestamp();
...
_L0:
          ...
          while (iVar2 = otDnsGetNextTxtEntry(&uStack_84,&pcStack_1bc), iVar2 == 0) {
            ...
            pcVar5 = pcStack_1bc;
            if ((pcVar6 == (char *)0x0) || (sVar15 = strnlen(pcStack_1bc,0x41), 0x40 < sVar15)) {
_L0:
