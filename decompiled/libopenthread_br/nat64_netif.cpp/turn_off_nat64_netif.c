 ...
 * Source: libopenthread_br -> nat64_netif.cpp.o -> turn_off_nat64_netif
 *
...
/* turn_off_nat64_netif(void*) */

undefined4 turn_off_nat64_netif(void *param_1)

{
  netif_set_down(s_nat64_netif);
  return 0;
}
