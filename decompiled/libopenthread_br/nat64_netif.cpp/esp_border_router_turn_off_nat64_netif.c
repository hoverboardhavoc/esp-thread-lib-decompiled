 ...
 * Source: libopenthread_br -> nat64_netif.cpp.o -> esp_border_router_turn_off_nat64_netif
 *
...
undefined4 esp_border_router_turn_off_nat64_netif(void)

{
  esp_openthread_task_switching_lock_release();
  esp_netif_tcpip_exec(turn_off_nat64_netif,0);
