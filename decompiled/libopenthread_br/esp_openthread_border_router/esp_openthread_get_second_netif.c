 ...
 * Source: libopenthread_br -> esp_openthread_border_router.o -> esp_openthread_get_second_netif
 *
...
undefined4 esp_openthread_get_second_netif(void)

{
  return s_second_netif;
}
