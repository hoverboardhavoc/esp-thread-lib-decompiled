 ...
 * Source: libopenthread_br -> esp_openthread_border_router.o -> esp_openthread_get_meshcop_instance_name
 *
...
undefined4 esp_openthread_get_meshcop_instance_name(void)

{
  return s_meshcop_instance_name;
}
