...

{
  ...
  iVar4 = *(int *)(param_1 + 4);
  uStack_94 = 0;
  memcpy(auStack_a4,(void *)(iVar4 + 8),0x10);
  memcpy(auStack_90,(void *)(iVar4 + 0x18),0x10);
      ...
      if ((byte)(cVar1 + 0x7bU) < 2) {
        if (cVar1 == -0x7a) {
          for (uVar9 = 0x10; uVar9 + 1 < __size; uVar9 = uVar5 + uVar9 & 0xffff) {
            ...
            if (((pcVar8[1] & 0x1fU) == 0) || (__size < uVar5)) {
            ...
            if (*pcVar8 == '\x18') {
              uStack_94 = 0;
              iVar4 = is_address_from_netif(auStack_a4,param_2);
              if (iVar4 == 0) {
                bVar2 = pcVar8[2];
                bVar3 = pcVar8[3];
                uVar6 = esp_log_timestamp();
...
_L0:
                  esp_log(3,"OPENTHREAD",pcVar8,uVar6,"OPENTHREAD");
                }
                else {
                  __n = (uint)(bVar2 >> 3);
                  if (__n + 8 <= uVar5) {
