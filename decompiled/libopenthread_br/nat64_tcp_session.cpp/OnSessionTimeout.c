 ...
 * Source: libopenthread_br -> nat64_tcp_session.cpp.o -> OnSessionTimeout
 *
...
/* idf::TcpSession::OnSessionTimeout(void*) */

void idf::TcpSession::OnSessionTimeout(void *param_1)

{
  Close((TcpSession *)param_1);
  return;
}
