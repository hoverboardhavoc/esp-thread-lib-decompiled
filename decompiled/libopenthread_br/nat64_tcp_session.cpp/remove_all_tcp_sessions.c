 ...
 * Source: libopenthread_br -> nat64_tcp_session.cpp.o -> remove_all_tcp_sessions
 *
...
void idf::TcpSession::remove_all_tcp_sessions(void)

{
  while (s_session_list != (TcpSession *)0x0) {
    Close(s_session_list);
  }
  return;
}
