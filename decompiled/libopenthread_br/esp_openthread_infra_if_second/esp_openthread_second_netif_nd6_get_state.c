 ...
 * Source: libopenthread_br -> esp_openthread_infra_if_second.o -> esp_openthread_second_netif_nd6_get_state
 *
...
undefined1 esp_openthread_second_netif_nd6_get_state(void)

{
  return s_netif_ra_enabled;
}
