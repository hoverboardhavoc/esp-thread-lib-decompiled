 ...
 * Source: libopenthread_br -> esp_openthread_discovery.cpp.o -> process_finished_service
 *
...
/* process_finished_service(pending_query_t*, mdns_search_once_s*, mdns_result_s*) */

void process_finished_service
...

{
  ...
  if ((*(int *)(param_1 + 800) == 0) && (*(int *)(param_1 + 0x324) == 0)) {
